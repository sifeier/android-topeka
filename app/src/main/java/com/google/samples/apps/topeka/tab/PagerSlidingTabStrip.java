...
package com.google.samples.apps.topeka.tab;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int underlineColor = 0xFF7e57c2;
...
//		canvas.drawRect(0, height - underlineHeight, tabsContainer.getWidth(), height, rectPaint);
		canvas.drawRect(0, height, tabsContainer.getWidth(), height + underlineHeight, rectPaint);
